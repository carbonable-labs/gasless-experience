...
import { baseUrl, parseResponse, postRequest, securedPostRequest } from "./utils";
...
export default async function buildTypedData(
    ...
    const body = apiKey ? securedPostRequest(payload, apiKey, options) : postRequest(payload, options);
